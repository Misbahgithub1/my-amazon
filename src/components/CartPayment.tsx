  ...
  return (
    <div className="flex flex-col gap-4 ">
      <div className="flex gap-2">
        ...
        <p className="text-sm">
          Your orders qualifies FREE Shipping by Choosing this option at
      ...
      {userInfo ? (
        <div className="flex flex-col items-center gap-3">
          <button
            ...
            className="w-full h-10 text-sm font-semibold bg-amazon_blue text-white rounded-lg hover:bg-amazon_yellow"
          >
            Proceed to buy
          </button>
        </div>
